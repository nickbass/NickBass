<?php
    ...
    if ( dynamic_sidebar( 'post' ) ){
        ...
        echo '<li><a href="' . esc_url( get_author_posts_url( $post -> post_author ) ) . '" title="' . sprintf( __( 'Writed by %s' , 'treeson' ), esc_attr( $name ) ) . '"><i class="mythemes-icon-user-5"></i>' . esc_html( $name ) . '</a></li>';
        ...
        if( has_category() ){
            ...
            echo '<h4 class="widget-title"><i></i>' . __( 'Article Categories' , 'treeson' ) . '</h4>';
            echo '<div>';
            echo '<ul>';
            echo '<li>';
            the_category( '</li><li>' );
        ...
        if( has_tag() ){
            ...
            echo '<h4 class="widget-title"><i></i>' . __( 'Article Tags' , 'treeson' ) . '</h4>';
